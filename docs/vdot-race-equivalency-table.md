# VDOT Race-Equivalency Table

VDOT values associated with race times over popular distances.

| VDOT | 1,500 m | Mile | 3,000 m | 2 miles | 5,000 m | 10,000 m | 15K | Half marathon | Marathon |
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
...
- Race-equivalent times estimate comparable performances at the same VDOT; they are not guaranteed predictions.
- Times below one hour are shown as minutes and seconds unless tenths are included.
- The source table uses a plus sign for the VDOT 77 1,500 m and mile values.
