        ...
        days: [
          ...
          },
          {
            ...
            workout: {
              ...
              segments: [
                { type: "easy", distance: 1.5, effort: "easy", description: "Warmup" },
                { type: "threshold", distance: 3, pace: 283, effort: "threshold", description: "Threshold" },
                { type: "easy", distance: 1, effort: "easy", description: "Cooldown" },
              ],
              estimatedDuration: 35,
              totalDistance: 5.5,
              weeklyMileageContribution: 5.5,
          ...
          },
          {
            ...
            workout: {
              ...
              description: "Easy run",
              segments: [
                { type: "easy", distance: 4, pace: 380, effort: "easy", description: "Continuous" },
              ],
          ...
          },
          {
            ...
            workout: {
              ...
              segments: [
                { type: "easy", distance: 6, pace: 380, effort: "easy", description: "Continuous" },
              ],
